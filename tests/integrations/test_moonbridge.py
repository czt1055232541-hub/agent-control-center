...
class MoonBridgeSwitchModelTests(unittest.TestCase):
    def test_settings_path_uses_resolver(self):
        ...
        with patch("feishu_stack.moonbridge.resolve_settings_path", return_value=expected):
            import feishu_stack.moonbridge as moonbridge
    ...
    def test_switch_model_success(self):
        ...
        with (
            ...
            patch("feishu_stack.integrations.codex.codex_config.switch_provider") as mock_switch_provider,
        ):
            cfg = _fake_config()
